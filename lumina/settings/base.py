...
# Keycloak group → Django group map. Keys are Keycloak group names.
#
...
LUMINA_OIDC_GROUP_MAP = {
    ...
    "admins": "admin",
    # The prefixed spellings, kept so a realm using either convention works untouched. Both map to
    # the same Django group, and a user in both gets it once.
    "almalinux-admins": "admin",
    "almalinux-reviewers": "reviewer",
    "almalinux-staff": "staff",
