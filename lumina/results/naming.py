...
def build_context(kind: str, device: dict, payload: dict | None = None,
    ...
    return {
        ...
        # Schema 1.2 and later. Older bundles have none, and a rule reading one renders empty and
        # falls through, which is how they keep the name they have always had.
        #
