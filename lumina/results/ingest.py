...
# outage here: a minor that added one optional section had every submission refused until somebody
# edited a Python set and deployed. Refusing a *major* is the check the contract actually asks for,
# and it is the one that fails only when something really did break.
