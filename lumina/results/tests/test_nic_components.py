...
def test_the_card_wins_when_pci_ids_names_it():
    """A discrete card's subsystem is the product somebody bought; the die is not."""
    vendor, model = nic_identity({"pci_ids": {
        "vendor": "Intel Corporation [8086]",
    ...
    assert model == "Ethernet Converged Network Adapter X710-DA2"
