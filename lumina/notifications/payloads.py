...
One builder per ``NotificationEndpoint.kind``, chosen by ``for_endpoint``. Mattermost is the
...
BUILDERS = {
    NotificationEndpoint.KIND_MATTERMOST: mattermost,
    NotificationEndpoint.KIND_GENERIC: generic,
}
