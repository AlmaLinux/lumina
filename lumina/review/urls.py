...
urlpatterns = [
    ...
    path("runs/<int:pk>/blacklist-device/", run_views.run_blacklist_device,
         name="run_blacklist_device"),
    path("results/<int:pk>/waive/", run_views.run_waive_result, name="run_waive_result"),
    path("results/<int:pk>/unwaive/", run_views.run_unwaive_result, name="run_unwaive_result"),
    ...
    path("survey-tokens/<int:pk>/approve/", views.survey_token_approve,
         name="survey_token_approve"),
    path("survey-tokens/<int:pk>/reject/", views.survey_token_reject,
         name="survey_token_reject"),
    path("survey-tokens/<int:pk>/request-changes/", views.survey_token_request_changes,
         name="survey_token_request_changes"),
    path("survey/rebuild/", views.survey_rollup_now, name="survey_rollup_now"),
    path("survey/facets/", views.survey_facets_rebuild, name="survey_facets_rebuild"),
    path("survey/<int:pk>/blacklist/", views.survey_blacklist_device,
         name="survey_blacklist_device"),
    path("naming/", views.naming_plan, name="naming_plan"),
    path("naming/new/", views.naming_rule_form, name="naming_rule_new"),
    path("naming/<int:pk>/", views.naming_rule_form, name="naming_rule_edit"),
    path("naming/<int:pk>/delete/", views.naming_rule_delete, name="naming_rule_delete"),
    path("naming/apply/", views.naming_apply, name="naming_apply"),
    path("naming/preview/", views.naming_preview, name="naming_preview"),
    path("survey/<int:pk>/", views.survey_submission_detail,
         name="survey_submission_detail"),
    path("survey/<int:pk>/accept/", views.survey_submission_accept,
         name="survey_submission_accept"),
    path("survey/<int:pk>/dismiss/", views.survey_submission_dismiss,
         name="survey_submission_dismiss"),
